...
const UPDATABLE_FIELDS = [
  "trade_name", "legal_name", "country_id", "city", "city_id", "state_id", "state", "address", "postal_code",
    ...
    const customer = await sql.begin(async (tx) => {
      const [customer] = await tx`
        update customers set
          ...
          country_id = ${merged.country_id}, city = ${merged.city}, city_id = ${merged.city_id}, state_id = ${merged.state_id}, state = ${merged.state}, address = ${merged.address}, postal_code = ${merged.postal_code},
