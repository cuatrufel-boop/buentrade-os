  ...
  properties: {
    items: {
      ...
      items: {
        type: "object",
        properties: {
          name: { type: "string", description: "The product name/description exactly as written in the source text — do not repeat a section header or temperature word that's already captured in the temperature field, and do not include a timing/availability qualifier (a month name, 'Week of 10/5', a date range like 'SEPT/OCT', a specific ship date like 'to ship on 9/11', 'October ship', a production-date note like '(Nov 2025 Prod)') or a shipping origin/incoterm (e.g. 'FOB Sioux Falls, SD', 'EXW Midwest') — none of that is part of what the product IS, and it all changes on every list." },
